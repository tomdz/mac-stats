...
@%:@ Generated by GNU Autoconf 2.61 for libsigar 1.6.2.
@%:@ 
...
PACKAGE_NAME='libsigar'
PACKAGE_TARNAME='libsigar'
PACKAGE_VERSION='1.6.2'
PACKAGE_STRING='libsigar 1.6.2'
PACKAGE_BUGREPORT=''

ac_unique_file="src/sigar.c"
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures libsigar 1.6.2 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR           documentation root @<:@DATAROOTDIR/doc/libsigar@:>@
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of libsigar 1.6.2:";;
   esac
  cat <<\_ACEOF
...
Optional Packages:
  ...
  --with-valgrind=binary  run the tests in valgrind to check for mem-leaks
  --with-lua              lua
...
It was created by libsigar $as_me 1.6.2, which was
...
{ echo "$as_me:$LINENO: checking for os type ($host_os)" >&5
echo $ECHO_N "checking for os type ($host_os)... $ECHO_C" >&6; }
FRAMEWORK=
case $host_os in
     *aix*)
     SRC_OS="aix"
...
cat >>confdefs.h <<\_ACEOF
@%:@define SIGAR_TEST_OS_SOLARIS 1
_ACEOF
...
{ echo "$as_me:$LINENO: result: $SRC_OS" >&5
echo "${ECHO_T}$SRC_OS" >&6; }



for ac_header in libproc.h valgrind/valgrind.h
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if { as_var=$as_ac_Header; eval "test \"\${$as_var+set}\" = set"; }; then
  { echo "$as_me:$LINENO: checking for $ac_header" >&5
...
INCLUDES="-I\$(top_srcdir)/include -I\$(top_srcdir)/src/os/$SRC_OS $SIGAR_INCLUDES"
 ...
 if test x$SRC_OS = xsolaris; then
  OS_SOLARIS_TRUE=
  OS_SOLARIS_FALSE='#'
else
  OS_SOLARIS_TRUE='#'
...
echo "${ECHO_T}no" >&6; }
  ...
  { { echo "$as_me:$LINENO: error: \"--with-valgrind ... but no valgrind found\"" >&5
echo "$as_me: error: \"--with-valgrind ... but no valgrind found\"" >&2;}
   { (exit 1); exit 1; }; }
fi
...
{ echo "$as_me:$LINENO: checking if with lua" >&5
echo $ECHO_N "checking if with lua... $ECHO_C" >&6; }
...
if test -n "$LUA_CFLAGS"; then
    ...
    { (echo "$as_me:$LINENO: \$PKG_CONFIG --exists --print-errors \"\$LUAPC >= 5.1\"") >&5
...
if $PKG_CONFIG --atleast-pkgconfig-version 0.20; then
        ...
        if test $_pkg_short_errors_supported = yes; then
	        LUA_PKG_ERRORS=`$PKG_CONFIG --short-errors --print-errors "$LUAPC >= 5.1" 2>&1`
        else 
	        LUA_PKG_ERRORS=`$PKG_CONFIG --print-errors "$LUAPC >= 5.1" 2>&1`
        fi
...
if test -z "${OS_MACOSX_TRUE}" && test -z "${OS_MACOSX_FALSE}"; then
  { { echo "$as_me:$LINENO: error: conditional \"OS_MACOSX\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
echo "$as_me: error: conditional \"OS_MACOSX\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
...
if test -z "${OS_HPUX_TRUE}" && test -z "${OS_HPUX_FALSE}"; then
  { { echo "$as_me:$LINENO: error: conditional \"OS_HPUX\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
echo "$as_me: error: conditional \"OS_HPUX\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${OS_AIX_TRUE}" && test -z "${OS_AIX_FALSE}"; then
  { { echo "$as_me:$LINENO: error: conditional \"OS_AIX\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
echo "$as_me: error: conditional \"OS_AIX\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
...
if test -z "${USE_VALGRIND_TRUE}" && test -z "${USE_VALGRIND_FALSE}"; then
  { { echo "$as_me:$LINENO: error: conditional \"USE_VALGRIND\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
echo "$as_me: error: conditional \"USE_VALGRIND\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${BUILD_LUA_TRUE}" && test -z "${BUILD_LUA_FALSE}"; then
  { { echo "$as_me:$LINENO: error: conditional \"BUILD_LUA\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
echo "$as_me: error: conditional \"BUILD_LUA\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
...
VERSION_MAINT!$VERSION_MAINT$ac_delim
VERSION_BUILD!$VERSION_BUILD$ac_delim
CC!$CC$ac_delim
...
CPP!$CPP$ac_delim
SRC_OS!$SRC_OS$ac_delim
INCLUDES!$INCLUDES$ac_delim
SIGAR_LIBS!$SIGAR_LIBS$ac_delim
OS_WIN32_TRUE!$OS_WIN32_TRUE$ac_delim
OS_WIN32_FALSE!$OS_WIN32_FALSE$ac_delim
OS_MACOSX_TRUE!$OS_MACOSX_TRUE$ac_delim
OS_MACOSX_FALSE!$OS_MACOSX_FALSE$ac_delim
OS_LINUX_TRUE!$OS_LINUX_TRUE$ac_delim
OS_LINUX_FALSE!$OS_LINUX_FALSE$ac_delim
OS_HPUX_TRUE!$OS_HPUX_TRUE$ac_delim
OS_HPUX_FALSE!$OS_HPUX_FALSE$ac_delim
OS_AIX_TRUE!$OS_AIX_TRUE$ac_delim
OS_AIX_FALSE!$OS_AIX_FALSE$ac_delim
OS_SOLARIS_TRUE!$OS_SOLARIS_TRUE$ac_delim
OS_SOLARIS_FALSE!$OS_SOLARIS_FALSE$ac_delim
VALGRIND!$VALGRIND$ac_delim
USE_VALGRIND_TRUE!$USE_VALGRIND_TRUE$ac_delim
USE_VALGRIND_FALSE!$USE_VALGRIND_FALSE$ac_delim
...
BUILD_LUA_TRUE!$BUILD_LUA_TRUE$ac_delim
BUILD_LUA_FALSE!$BUILD_LUA_FALSE$ac_delim
